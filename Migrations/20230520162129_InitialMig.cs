    ...
    public partial class InitialMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "test@.pl", "Filip", "Michalski" },
                    { 2, "test1@.pl", "Michal", "Filipski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "test3@.pl", "Adam", "Mickiewicz" },
                    { 2, "test4@.pl", "Adam", "Małysz" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Login", "Password", "RefreshToken", "RefreshTokenExp" },
                values: new object[] { 1, "admin", "admin", null, null });

            migrationBuilder.InsertData(
                table: "Prescriptions",
                columns: new[] { "IdPrescription", "Date", "DueDate", "IdDoctor", "IdPatient" },
                values: new object[] { 1, new DateTime(2023, 5, 20, 18, 21, 29, 599, DateTimeKind.Local).AddTicks(2900), new DateTime(2025, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 2 });

            migrationBuilder.InsertData(
                table: "PrescriptionMedicaments",
                columns: new[] { "IdMedicament", "IdPrescription", "Details", "Dose" },
                values: new object[] { 2, 1, "Pacjent niestabilny psychicznie", 100 });
